...
# %% #Train Test Set
df = pd.read_excel('../Data/MultiDonor_Phase_IDO.xlsx')
...
for i in range(N_cv):
    ...
    Train_Orig = Train[Train['RB_Donor'] != 'RB277_UT'] # exclude RB277 in Training data
    X_train = Train_Orig.drop(['RB_Donor', 'level_1', 'RB_IDO', 'ImageNumber', 'ObjectNumber',],axis=1)
    y_train = np.around(Train_Orig.RB_IDO.to_numpy(),2)

    X_test = df.iloc[i*n_each:(i+1)*n_each].drop(['RB_Donor', 'level_1', 'RB_IDO', 'ImageNumber', 'ObjectNumber',],axis=1)
...
df_score.to_excel(r'../Data/ModelCVScore_Phase_IDO.xlsx')
# %%
avg_result = {}
for scoring_name, scoring_method in scoring_methods.items():
    try:
...
Pred_RFR.to_excel(r'../Data/PredictionResult/Phase_PredIDO_RFR_Prediction_5foldcv.xlsx', index=False)
Pred_RFR = pd.read_excel('../Data/PredictionResult/Phase_PredIDO_RFR_Prediction_5foldcv.xlsx')
# %%
...
Pred_SVR.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_SVR_Prediction_5foldcv.xlsx', index=False)
Pred_SVR = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_SVR_Prediction_5foldcv.xlsx')
...
plt.tick_params(labelsize = 27) 
plt.legend(bbox_to_anchor=(1.3, 1),fontsize = 18, borderaxespad=0)
plt.savefig('../Plot/UT_Fluo_Pred/Phase_PredIDO_SVR.svg', format="svg",dpi=300,bbox_inches='tight')  
# %%
Pred_GBR = pd.DataFrame(result_dict_df['GBR'])
Pred_GBR.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_GBR_Prediction_5foldcv.xlsx', index=False)
Pred_GBR = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_GBR_Prediction_5foldcv.xlsx')
...
plt.tick_params(labelsize = 27) 
plt.legend(bbox_to_anchor=(1.3, 1),fontsize = 18, borderaxespad=0)
plt.savefig('../Plot/UT_Fluo_Pred/Phase_PredIDO_GBR.svg', format="svg",dpi=300,bbox_inches='tight')  
# %%
Pred_MLPR = pd.DataFrame(result_dict_df['MLPR'])
Pred_MLPR.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_MLPR_Prediction_5foldcv.xlsx', index=False)
Pred_MLPR = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_MLPR_Prediction_5foldcv.xlsx')
...
Pred_SVR_L.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_SVR_L_Prediction_5foldcv.xlsx', index=False)
Pred_SVR_L = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_SVR_L_Prediction_5foldcv.xlsx')
...
plt.tick_params(labelsize = 27) 
plt.legend(bbox_to_anchor=(1.3, 1),fontsize = 18, borderaxespad=0)
plt.savefig('../Plot/UT_Fluo_Pred/Phase_PredIDO_SVR_L.svg', format="svg",dpi=300,bbox_inches='tight')  
# %%
# %%
Pred_LASSO = pd.DataFrame(result_dict_df['LASSO'])
Pred_LASSO.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_LASSO_Prediction_5foldcv.xlsx', index=False)
Pred_LASSO = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Phase_PredIDO_LASSO_Prediction_5foldcv.xlsx')
...
plt.tick_params(labelsize = 27) 
plt.legend(bbox_to_anchor=(1.3, 1),fontsize = 18, borderaxespad=0)
plt.savefig('../Plot/UT_Fluo_Pred/Phase_PredIDO_LASSO.svg', format="svg",dpi=300,bbox_inches='tight')  