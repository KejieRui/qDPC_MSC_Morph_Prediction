...
df = pd.read_excel('../Data/RevisionSup_Cell.xlsx', sheet_name="Media")
...
sns.scatterplot(data=pca_df, x='PC1', y='PC2', hue='Condition', s=60)

plt.xlabel(f'PC1 ({explained_var[0]:.1f}% Variance)', fontsize=30)
plt.ylabel(f'PC2 ({explained_var[1]:.1f}% Variance)', fontsize=30)
plt.tick_params(labelsize = 25) 
plt.title('PCA of DPC Features: MEM vs RB Media\n', fontsize=20)
legend=plt.legend(fontsize=25,)
# Resize legend marker points
for handle in legend.legendHandles:
    handle._sizes = [250]  
plt.tight_layout()
plt.savefig('../Plot/RevisionSup/RB183_MediaComparison_DPCFeatures.svg', format="svg",dpi=300,bbox_inches='tight') 
...
plt.savefig('../Plot/RevisionSup/RB183_MediaComparison_DPCFeatures_PC1Importance.svg', format="svg",dpi=300,bbox_inches='tight') 
# %%
...
ax.set_ylabel(" ", fontsize = 30)
ax.tick_params(labelsize = 10)
plt.savefig('../Plot/RevisionSup/RB183_MediaComparison_DPCFeatures_PC2Importance.svg', format="svg",dpi=300,bbox_inches='tight') 
...
plt.ylabel(f'PC2 ({explained_var[1]:.1f}% Variance)', fontsize=30)
plt.tick_params(labelsize = 25) 
plt.title('PCA of Morph Features: MEM vs RB Media\n', fontsize=20)
legend=plt.legend(fontsize=25,)
# Resize legend marker points
for handle in legend.legendHandles:
    handle._sizes = [250]  
plt.tight_layout()
plt.savefig('../Plot/RevisionSUp/RB183_MediaComparison_MorphFeatures.svg', format="svg",dpi=300,bbox_inches='tight') 
# %%
...
ax.set_ylabel(" ", fontsize = 30)
ax.tick_params(labelsize = 10)
plt.savefig('../Plot/RevisionSup/RB183_MediaComparison_MorphFeatures_PC1Importance.svg', format="svg",dpi=300,bbox_inches='tight') 
# %%
PC2Loading = PCLoading.sort_values(['PC2']).reset_index(drop=True)
plt.figure(figsize=(6,16))
...
ax.set_ylabel(" ", fontsize = 30)
ax.tick_params(labelsize = 10)
plt.savefig('../Plot/RevisionSup/RB183_MediaComparison_MorphFeatures_PC2Importance.svg', format="svg",dpi=300,bbox_inches='tight') 
