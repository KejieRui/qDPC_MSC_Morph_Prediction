...
rfr = RandomForestRegressor(n_estimators=9, max_depth=3, random_state=42)
gbr = GradientBoostingRegressor(n_estimators=300, learning_rate=0.01, max_depth=3,random_state=42)
svr = SVR(C= 0.1, epsilon=0.1, kernel='rbf')
mlpr = MLPRegressor(activation='tanh', alpha= 201,hidden_layer_sizes= (50, 50, 50),learning_rate= 'constant',max_iter= 400,solver= 'sgd')
svrl = SVR(C= 0.1, epsilon=0.3, kernel='linear')
lasso = Lasso(alpha=0.5145454545454545)
...
for i in range(N_cv):
    ...
    Train_RM = Train.groupby('Donor1').rolling(center=False,window=int(n_each*(N_cv-1)/10),min_periods=1).mean().reset_index()
    X_train = Train_RM.drop(['Donor1', 'level_1', 'Donor2', 'RB_IDO', 'ImageNumber', 'ObjectNumber',],axis=1)
    y_train = np.around(Train_RM.RB_IDO.to_numpy(),2)

    Test=df.iloc[i*n_each:(i+1)*n_each]
    Test_RM = Test.groupby('Donor1').rolling(center=False,window=int(n_each/10),min_periods=1).mean().reset_index()
    X_test = Test_RM.drop(['Donor1', 'level_1', 'Donor2', 'RB_IDO', 'ImageNumber', 'ObjectNumber',],axis=1)
    y_test = np.around(Test_RM.RB_IDO.to_numpy(),2)
...
df_score.to_excel(r'../Data/ModelCVScore_Fluo_IFN.xlsx')
# %%
avg_result = {}
for scoring_name, scoring_method in scoring_methods.items():
    try:
...
Pred_RFR.to_excel(r'../Data/PredictionResult/Fluo_IFN_RFR_Prediction_5foldcv.xlsx', index=False)
Pred_RFR = pd.read_excel('../Data/PredictionResult/Fluo_IFN_RFR_Prediction_5foldcv.xlsx')
# %%
...
Pred_SVR.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_SVR_Prediction_5foldcv.xlsx', index=False)
Pred_SVR = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_SVR_Prediction_5foldcv.xlsx')
...
plt.tick_params(labelsize = 27) 
plt.legend(bbox_to_anchor=(1.3, 1),fontsize = 18, borderaxespad=0)
plt.savefig('../Plot/IFN_Fluo_Pred/Fluo_IFN_SVR.svg', format="svg",dpi=300,bbox_inches='tight')  
# %%
Pred_GBR = pd.DataFrame(result_dict_df['GBR'])
Pred_GBR.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_GBR_Prediction_5foldcv.xlsx', index=False)
Pred_GBR = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_GBR_Prediction_5foldcv.xlsx')
...
plt.tick_params(labelsize = 27) 
plt.legend(bbox_to_anchor=(1.3, 1),fontsize = 18, borderaxespad=0)
plt.savefig('../Plot/IFN_Fluo_Pred/Fluo_IFN_GBR.svg', format="svg",dpi=300,bbox_inches='tight')  
# %%
Pred_MLPR = pd.DataFrame(result_dict_df['MLPR'])
Pred_MLPR.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_MLPR_Prediction_5foldcv.xlsx', index=False)
Pred_MLPR = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_MLPR_Prediction_5foldcv.xlsx')
...
Pred_SVR_L.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_SVR_L_Prediction_5foldcv.xlsx', index=False)
Pred_SVR_L = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_SVR_L_Prediction_5foldcv.xlsx')
...
plt.tick_params(labelsize = 27) 
plt.legend(bbox_to_anchor=(1.3, 1),fontsize = 18, borderaxespad=0)
plt.savefig('../Plot/IFN_Fluo_Pred/Fluo_IFN_SVR_L.svg', format="svg",dpi=300,bbox_inches='tight')  
# %%
# %%
Pred_LASSO = pd.DataFrame(result_dict_df['LASSO'])
Pred_LASSO.to_excel(r'F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_LASSO_Prediction_5foldcv.xlsx', index=False)
Pred_LASSO = pd.read_excel('F:/MortensenLab_Jessica/mLab_Work/Data/MultipleDonor/MultiDonorIDOPrediction/Fluo_IFN_LASSO_Prediction_5foldcv.xlsx')
...
plt.tick_params(labelsize = 27) 
plt.legend(bbox_to_anchor=(1.3, 1),fontsize = 18, borderaxespad=0)
plt.savefig('../Plot/IFN_Fluo_Pred/Fluo_IFN_LASSO.svg', format="svg",dpi=300,bbox_inches='tight')  